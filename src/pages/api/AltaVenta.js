...
export default async function handler(req, res) {
    ...
    const {  ID_clientes, fecha_venta, subtotal, descuento, total, total_pagado, cambio } = req.body;

    if (!ID_clientes || !fecha_venta || !subtotal || !descuento || !total || !total_pagado || !cambio) {
